...
Below you can find instructions for configs setup applicable for Sitecore 10.2.1. Different Sitecore versions may requre slightly different configuration. Use default Lucene search config files to identify these variations.

For Sitecore 9.1 take a look in (https://github.com/chorpo/Sitecore.Algolia) prepared by [Peter Procházka](https://github.com/chorpo)
